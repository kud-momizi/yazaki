...
class HospitalAvailabilitiesTableCreate extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hospital_availabilities', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hospital_availabilities');
    }
}
